...
class _GoogleMapScreenState extends State<GoogleMapScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      await LocationPermission.getCurrentLocation();
      setState(() {});
    });
  }
  ...
  void watchMyLocation() {
    LocationPermission.getLiveLocation().listen((location) {
  ...
  void addLocationMarker() {
    setState(() {
      ...
      if (myPositions.length > 1) {
        LocationPermission.fetchPolylinePoints(myPositions, travelMode)
        ...
        children: [
          ...
          Positioned(
            ...
            child: GooglePlacesAutoCompleteTextFormField(
                ...
                googleAPIKey: "AIzaSyA0BsEWdGyUeF_2ygie0tgqOWbKyVP0P0A",
